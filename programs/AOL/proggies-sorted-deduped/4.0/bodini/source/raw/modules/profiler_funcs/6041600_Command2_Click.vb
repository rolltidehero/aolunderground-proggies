Private Sub Command2_Click() '5C3000
  Dim var_34 As TextBox
  Dim var_CC As TextBox
  loc_005C30A1: var_2C = Text1.Text
  loc_005C30C5: var_3C = var_2C
  loc_005C3105: var_9C = "•bodini 4.0• profile •"
  loc_005C313B: var_30 = "•bodini 4.0• profile •" & LCase(var_2C) & &H42EC60
  ...
  loc_005C333A: var_AC = "• profiler •complete•"
  loc_005C3362: var_30 = &H42EC60 & LCase(var_2C) & "• profiler •complete•"
